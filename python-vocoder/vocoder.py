"""
vocoder.py
What I previously though the phase vocoder algorithm for pitch scaling was - 
scale the phase differences from corresponding bins in previous frame by a 
constant factor.

Based on https://github.com/JentGent/pitch-shift/blob/main/audios.ipynb with
commented variable names being corresponding names in the original code
"""
